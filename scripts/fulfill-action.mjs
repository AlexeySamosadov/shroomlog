/** Autonomous order fulfilment for ShroomLog — GitHub Action on new issue.
...
comment(["✅ **Payment verified — your ShroomLog Pro license:**", "", "Open ShroomLog → **Pro** → *Have a key?* → paste:", "", "```", license, "```", "", "Lifetime, works offline. Happy growing 🍄"].join("\n"));
